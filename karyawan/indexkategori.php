<html>  
    ...
    <body>  
        <div id="main_container">  
            ...
            switch ($page) {
                case 'tambah' : include "tambahkategori.php"; break;  
                case 'ubah' : include "ubahkategori.php"; break;  
                case 'hapus' : include "hapuskategori.php"; break;  
                case 'utama' :  
                default : include 'tampilkategori.php';     
            }  
            ?>  
        </div>  
    </body>  
