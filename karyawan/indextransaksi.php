<html>  
    ...
    <body>  
        <div id="main_container">  
            ...
            switch ($page) {
                case 'tambah' : include "tambahtransaksi.php"; break;  
                case 'ubah' : include "ubahtransaksi.php"; break;  
                case 'hapus' : include "hapustransaksi.php"; break;  
                case 'utama' :  
                default : include 'tampiltransaksi.php';     
            }  
            ?>  
        </div>  
    </body>  
